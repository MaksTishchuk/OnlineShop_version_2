...
class CategoryMixin(SingleObjectMixin):
    """Подмешиваем наши категории в контекст для вывода в сайдбар всех страниц"""
    ...
    def get_context_data(self, **kwargs):
        """Подмешиваем в контекст категории и товары в данной категории"""
...
class CartMixin(View):
    """Миксин для получение существующей корзины или создание новой"""
